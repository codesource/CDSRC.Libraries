 ...
 */
class TranslationTest extends \TYPO3\Flow\Tests\UnitTestCase {
    
    /**
     * @test
     */
    public function loadGenericTranslationClassForTranslatableEntity(){
        $object = new \CDSRC\Libraries\Tests\Unit\Translatable\Fixture\Model\Generic();
        $translationClass = $object->getTranslationClass();
    ...
    public function loadSpecificTranslationClassForTranslatableEntity(){
        $object = new \CDSRC\Libraries\Tests\Unit\Translatable\Fixture\Model\Specific();
        $translationClass = $object->getTranslationClass();
