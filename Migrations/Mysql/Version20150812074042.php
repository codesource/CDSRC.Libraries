...
class Version20150812074042 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE cdsrc_libraries_translatable_domain_model_abstracttranslatable (persistence_object_identifier VARCHAR(40) NOT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  ENGINE = InnoDB");
		...
		$this->addSql("CREATE TABLE cdsrc_libraries_translatable_domain_model_generictranslation (persistence_object_identifier VARCHAR(40) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  ENGINE = InnoDB");
